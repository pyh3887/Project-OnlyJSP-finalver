...
<div class="total">
		...
		<div class="contents">
				<div>														
				<button name="total" onclick="total()">전체</button>
				<button name="motel" onclick="motel()">모텔</button>
				<button name="motel" onclick="hotel()">호텔</button>
				<button name="motel" onclick="guest()">게스트하우스</button>
				<button name="motel" onclick="pension()">펜션</button>
				</div>				
